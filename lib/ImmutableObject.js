...
const { baseAsMutable, baseGet, baseSet, baseUpdate, errors, verifySources } = require('./utils/index');
...
function ImmutableObject(immutable, freeze) {
    ...
    Object.defineProperty(immutable, 'merge', {
        value: function (...sources) {
            verifySources.call(this, sources);
    ...
    // returns a shiny new EasyImmutable array obj
