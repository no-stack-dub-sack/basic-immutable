module.exports = {
    ...
    MERGE: (offender) => `Source object cannot be merged with target, key "${offender}" is not allowed: The "merge" method only allows merging of objects with common own properties, use "mergeTolerant" instead.`,
}
